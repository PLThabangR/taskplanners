...
//We need to send this as part of the headers
 ...
 //We want to add a hearder to every request that is sent out
    ...
    request=request.clone({//We clone it and override some certain properties
      setHeaders :{Authorization:basicAuthHeaderString} //The only thing which is changing is adding authorization
    })
